...
import com.wkclz.mybatis.mapper.impl.BaseMapperProvider;
...
public interface BaseMapper<T extends BaseEntity> {
    ...
    @UpdateProvider(type = BaseMapperProvider.class, method = "updateByIdSelective")
    int updateByIdSelective(T entity);
    
    @Desc("批量更新数据，不带乐观锁")
    @UpdateProvider(type = BaseMapperProvider.class, method = "updateBatch")
    ...
    @SelectProvider(type = BaseMapperProvider.class, method = "selectByIds")
    ...
    @SelectProvider(type = BaseMapperProvider.class, method = "selectByEntity")
    ...
    @SelectProvider(type = BaseMapperProvider.class, method = "selectOneByEntity")
