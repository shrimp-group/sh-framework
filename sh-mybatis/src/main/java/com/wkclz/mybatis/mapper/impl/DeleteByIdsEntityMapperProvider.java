 ...
 */
@Slf4j
public class DeleteByIdsEntityMapperProvider extends BaseMapperProvider {
     ...
     * @return SQL字符串
     */
    public String deleteByIdsEntity(BaseEntity entity) throws IllegalAccessException {
        if (entity == null) {
